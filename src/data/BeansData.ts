const BeansData = [
  {
    ...
    imagelink_square: require('http://192.168.1.9:3000/images/robusta_coffee_beans/robusta_coffee_beans_square.png'),
    imagelink_portrait: require('http://192.168.1.9:3000/images/robusta_coffee_beans/robusta_coffee_beans_portrait.png'),
    ingredients: 'Africa',
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('http://192.168.1.9:3000/images/arabica_coffee_beans/arabica_coffee_beans_square.png'),
    imagelink_portrait: require('http://192.168.1.9:3000/images/arabica_coffee_beans/arabica_coffee_beans_portrait.png'),
    ingredients: 'Africa',
    special_ingredient: 'From Africa',
    prices: [
      {size: '250gm', price: '5.50', currency: '$'},
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('http://192.168.1.9:3000/images/liberica_coffee_beans/liberica_coffee_beans_square.png'),
    imagelink_portrait: require('http://192.168.1.9:3000/images/liberica_coffee_beans/liberica_coffee_beans_portrait.png'),
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('http://192.168.1.9:3000/images/excelsa_coffee_beans/excelsa_coffee_beans_square.png'),
    imagelink_portrait: require('http://192.168.1.9:3000/images/robusta_coffee_beans/robusta_coffee_beans_square.png'),
    ingredients: 'Malaysia',
    special_ingredient: 'From Malaysia',
    prices: [
      {size: '250gm', price: '5.50', currency: '$'},
